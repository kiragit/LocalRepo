...
<body>
  ...
  <span class="hljs-keyword">var</span> Docco, buildMatchers, commander, configure, defaults, document, format, fs, getLanguage, highlightjs, languages, marked, parse, path, run, version, write, _,
    __slice = [].slice;

  document = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(options, callback)</span> {</span>
    ...
    marked.setOptions({
      highlight: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(code, lang)</span> {</span>
        ...
        <span class="hljs-keyword">if</span> (highlightjs.getLanguage(lang)) {
          ...
          console.warn(<span class="hljs-string">"docco: couldn't highlight code block with unknown language '"</span> + lang + <span class="hljs-string">"' in "</span> + source);
  ...
  write = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(source, sections, config)</span> {</span>
    ...
    console.log(<span class="hljs-string">"docco: "</span> + source + <span class="hljs-string">" -&gt; "</span> + (destination(source)));
  ...
  configure = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(options)</span> {</span>
    ...
    config.sources = options.args.filter(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(source)</span> {</span>
      ...
      <span class="hljs-keyword">if</span> (!lang) {
        console.warn(<span class="hljs-string">"docco: skipped unknown type ("</span> + (path.basename(source)) + <span class="hljs-string">")"</span>);
      }
  ...
  run = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(args)</span> {</span>
    ...
    <span class="hljs-keyword">if</span> (commander.args.length) {
      <span class="hljs-keyword">return</span> document(commander);
    } <span class="hljs-keyword">else</span> {
      <span class="hljs-keyword">return</span> console.log(commander.helpInformation());
    }
  };
