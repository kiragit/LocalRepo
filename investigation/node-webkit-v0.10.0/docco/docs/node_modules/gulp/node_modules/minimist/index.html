  ...
  <div id="container">
    ...
    <ul class="sections">
        ...
        <li id="section-1">
            ...
            <div class="content"><div class='highlight'><pre>module.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(args, opts)</span> {</span>
    <span class="hljs-keyword">if</span> (!opts) opts = {};
    
    <span class="hljs-keyword">var</span> flags = { bools : {}, strings : {} };
