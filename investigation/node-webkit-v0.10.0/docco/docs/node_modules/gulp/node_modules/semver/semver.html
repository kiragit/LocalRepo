  ...
  <div id="container">
    ...
    <ul class="sections">
        ...
        <li id="section-1">
            ...
            <div class="content"><div class='highlight'><pre><span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> module === <span class="hljs-string">'object'</span> &amp;&amp; module.exports === exports)
  exports = module.exports = SemVer;</pre></div></div>
...
<span class="hljs-comment">/* nomin */</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> process === <span class="hljs-string">'object'</span> &amp;&amp;
  ...
  <span class="hljs-comment">/* nomin */</span> debug = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> {</span>
    ...
    <span class="hljs-comment">/* nomin */</span> console.log.apply(console, args);
...
Not necessarily the package version of this code.</p>
            ...
            <div class="content"><div class='highlight'><pre>exports.SEMVER_SPEC_VERSION = <span class="hljs-string">'2.0.0'</span>;</pre></div></div>
...
src[XRANGEPLAINLOOSE] = <span class="hljs-string">'[v=\\s]*('</span> + src[XRANGEIDENTIFIERLOOSE] + <span class="hljs-string">')'</span> +
        ...
        <li id="section-17">
            <div class="annotation">
              ...
              <blockquote>
<p>=2.x, for example, means &gt;=2.0.0-0</p>
<p>&lt;1.x would be the same as “&lt;1.0.0-0”, though.</p>
</blockquote>

            </div>
            
            <div class="content"><div class='highlight'><pre><span class="hljs-keyword">var</span> XRANGE = R++;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parse</span><span class="hljs-params">(version, loose)</span> {</span>
  ...
  <span class="hljs-keyword">return</span> (r.test(version)) ? <span class="hljs-keyword">new</span> SemVer(version, loose) : <span class="hljs-literal">null</span>;
}
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">clean</span><span class="hljs-params">(version, loose)</span> {</span>
  <span class="hljs-keyword">var</span> s = parse(version, loose);
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">SemVer</span><span class="hljs-params">(version, loose)</span> {</span>
  ...
  <span class="hljs-keyword">this</span>.patch = +m[<span class="hljs-number">3</span>];</pre></div></div>
  ...
  <span class="hljs-keyword">else</span>
    <span class="hljs-keyword">this</span>.prerelease = m[<span class="hljs-number">4</span>].split(<span class="hljs-string">'.'</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(id)</span> {</span>
      <span class="hljs-keyword">return</span> (<span class="hljs-regexp">/^[0-9]+$/</span>.test(id)) ? +id : id;
    });
...
down to pre-release. premajor and prepatch work the same way.</p>
            ...
            <div class="content"><div class='highlight'><pre>SemVer.prototype.inc = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(release)</span> {</span>
  <span class="hljs-keyword">switch</span> (release) {
    <span class="hljs-keyword">case</span> <span class="hljs-string">'premajor'</span>:
      <span class="hljs-keyword">this</span>.inc(<span class="hljs-string">'major'</span>);
      <span class="hljs-keyword">this</span>.inc(<span class="hljs-string">'pre'</span>);
      <span class="hljs-keyword">break</span>;
    <span class="hljs-keyword">case</span> <span class="hljs-string">'preminor'</span>:
      <span class="hljs-keyword">this</span>.inc(<span class="hljs-string">'minor'</span>);
      <span class="hljs-keyword">this</span>.inc(<span class="hljs-string">'pre'</span>);
      <span class="hljs-keyword">break</span>;
...
relevant at this point.</p>
      ...
      <span class="hljs-keyword">this</span>.inc(<span class="hljs-string">'patch'</span>);
      <span class="hljs-keyword">this</span>.inc(<span class="hljs-string">'pre'</span>);
...
prepatch.</p>
    ...
    <span class="hljs-keyword">case</span> <span class="hljs-string">'major'</span>:
      ...
      <span class="hljs-keyword">this</span>.minor = -<span class="hljs-number">1</span>;
      ...
      <span class="hljs-keyword">break</span>;</pre></div></div>
        ...
        <li id="section-33">
            <div class="annotation">
              ...
              <p>This probably shouldn’t be used publically.
...
exports.inc = inc;
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">inc</span><span class="hljs-params">(version, release, loose)</span> {</span>
  <span class="hljs-keyword">try</span> {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> SemVer(version, loose).inc(release).version;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">cmp</span><span class="hljs-params">(a, op, b, loose)</span> {</span>
  ...
  <span class="hljs-keyword">switch</span> (op) {
    <span class="hljs-keyword">case</span> <span class="hljs-string">'==='</span>: ret = a === b; <span class="hljs-keyword">break</span>;
    <span class="hljs-keyword">case</span> <span class="hljs-string">'!=='</span>: ret = a !== b; <span class="hljs-keyword">break</span>;
...
Comparator.prototype.parse = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(comp)</span> {</span>
  ...
  <span class="hljs-keyword">this</span>.operator = m[<span class="hljs-number">1</span>];</pre></div></div>
  ...
  <span class="hljs-keyword">else</span> {
    <span class="hljs-keyword">this</span>.semver = <span class="hljs-keyword">new</span> SemVer(m[<span class="hljs-number">2</span>], <span class="hljs-keyword">this</span>.loose);</pre></div></div>
        ...
        <li id="section-35">
            <div class="annotation">
              ...
              <p>&lt;1.2.3-rc DOES allow 1.2.3-beta (has prerelease)</p>
<blockquote>
<p>=1.2.3 DOES NOT allow 1.2.3-beta
&lt;=1.2.3 DOES allow 1.2.3-beta
However, &lt;1.2.3 does NOT allow 1.2.3-beta,
even though <code>1.2.3-beta &lt; 1.2.3</code>
The assumption is that the 1.2.3 version has something you
<em>don’t</em> want, so we push the prerelease down to the minimum.</p>
</blockquote>

            </div>
            
            <div class="content"><div class='highlight'><pre>    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.operator === <span class="hljs-string">'&lt;'</span> &amp;&amp; !<span class="hljs-keyword">this</span>.semver.prerelease.length) {
      <span class="hljs-keyword">this</span>.semver.prerelease = [<span class="hljs-string">'0'</span>];
      <span class="hljs-keyword">this</span>.semver.format();
    }
  }
};
...
Comparator.prototype.test = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(version)</span> {</span>
  ...
  <span class="hljs-keyword">return</span> (<span class="hljs-keyword">this</span>.semver === ANY) ? <span class="hljs-literal">true</span> :
         cmp(version, <span class="hljs-keyword">this</span>.operator, <span class="hljs-keyword">this</span>.semver, <span class="hljs-keyword">this</span>.loose);
};
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">replaceTilde</span><span class="hljs-params">(comp, loose)</span> {</span>
  ...
  <span class="hljs-keyword">return</span> comp.replace(r, <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(_, M, m, p, pr)</span> {</span>
    ...
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isX(m))
      ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.0.0-0 &lt;'</span> + (+M + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0.0-0'</span>;
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isX(p))</pre></div></div>
        ...
        <li id="section-48">
            ...
            <div class="content"><div class='highlight'><pre>      ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.0-0 &lt;'</span> + M + <span class="hljs-string">'.'</span> + (+m + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0-0'</span>;
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (pr) {
      ...
      ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.'</span> + p + pr +
            <span class="hljs-string">' &lt;'</span> + M + <span class="hljs-string">'.'</span> + (+m + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0-0'</span>;
        ...
        <li id="section-49">
            <div class="annotation">
              ...
              <p>~1.2.3 == &gt;=1.2.3-0 &lt;1.3.0-0</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.'</span> + p + <span class="hljs-string">'-0'</span> +
            <span class="hljs-string">' &lt;'</span> + M + <span class="hljs-string">'.'</span> + (+m + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0-0'</span>;
  ...
  <span class="hljs-keyword">return</span> comp.replace(r, <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(_, M, m, p, pr)</span> {</span>
    ...
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isX(p)) {
      <span class="hljs-keyword">if</span> (M === <span class="hljs-string">'0'</span>)
        ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.0-0 &lt;'</span> + M + <span class="hljs-string">'.'</span> + (+m + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0-0'</span>;
      <span class="hljs-keyword">else</span>
        ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.0-0 &lt;'</span> + (+M + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0.0-0'</span>;
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (pr) {
      ...
      <span class="hljs-keyword">if</span> (M === <span class="hljs-string">'0'</span>) {
        ...
        ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.'</span> + p + pr +
              <span class="hljs-string">' &lt;'</span> + (+M + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0.0-0'</span>;
    } <span class="hljs-keyword">else</span> {
      <span class="hljs-keyword">if</span> (M === <span class="hljs-string">'0'</span>) {
        <span class="hljs-keyword">if</span> (m === <span class="hljs-string">'0'</span>)
          ret = <span class="hljs-string">'='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.'</span> + p;
        <span class="hljs-keyword">else</span>
          ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.'</span> + p + <span class="hljs-string">'-0'</span> +
                <span class="hljs-string">' &lt;'</span> + M + <span class="hljs-string">'.'</span> + (+m + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0-0'</span>;
      } <span class="hljs-keyword">else</span>
        ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.'</span> + p + <span class="hljs-string">'-0'</span> +
              <span class="hljs-string">' &lt;'</span> + (+M + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0.0-0'</span>;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">replaceXRange</span><span class="hljs-params">(comp, loose)</span> {</span>
  ...
  <span class="hljs-keyword">return</span> comp.replace(r, <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(ret, gtlt, M, m, p, pr)</span> {</span>
    ...
    <span class="hljs-keyword">if</span> (gtlt &amp;&amp; anyX) {</pre></div></div>
        ...
        <li id="section-51">
            <div class="annotation">
              ...
              <p>replace X with 0, and then append the -0 min-prerelease</p>
...
1.2.3 =&gt; &gt;= 1.2.4-0</p>
        ...
        <span class="hljs-keyword">if</span> (xM) {</pre></div></div>
        ...
        <li id="section-53">
            ...
            <div class="content"><div class='highlight'><pre>        } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (xm) {
      ...
      ret = gtlt + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.'</span> + p + <span class="hljs-string">'-0'</span>;
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (xM) {</pre></div></div>
        ...
        <li id="section-55">
            <div class="annotation">
              ...
              <p>append ‘-0’ onto the version, otherwise
‘1.x.x’ matches ‘2.0.0-beta’, since the tag
<em>lowers</em> the version value</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.0.0-0 &lt;'</span> + (+M + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0.0-0'</span>;
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (xp) {
      ret = <span class="hljs-string">'&gt;='</span> + M + <span class="hljs-string">'.'</span> + m + <span class="hljs-string">'.0-0 &lt;'</span> + M + <span class="hljs-string">'.'</span> + (+m + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0-0'</span>;
    }
...
1.2 - 3.4 => &gt;=1.2.0-0 &lt;3.5.0-0</p>
  ...
  <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isX(fm))
    from = <span class="hljs-string">'&gt;='</span> + fM + <span class="hljs-string">'.0.0-0'</span>;
  <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isX(fp))
    from = <span class="hljs-string">'&gt;='</span> + fM + <span class="hljs-string">'.'</span> + fm + <span class="hljs-string">'.0-0'</span>;
  <span class="hljs-keyword">else</span>
  ...
  <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isX(tm))
    to = <span class="hljs-string">'&lt;'</span> + (+tM + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0.0-0'</span>;
  <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isX(tp))
    to = <span class="hljs-string">'&lt;'</span> + tM + <span class="hljs-string">'.'</span> + (+tm + <span class="hljs-number">1</span>) + <span class="hljs-string">'.0-0'</span>;
