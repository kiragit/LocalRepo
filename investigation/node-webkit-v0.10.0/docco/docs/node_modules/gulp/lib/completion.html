...
module.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(name)</span> {</span>
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> name !== <span class="hljs-string">'string'</span>) {
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'Missing completion type'</span>);
  }
  <span class="hljs-keyword">var</span> file = path.join(__dirname, <span class="hljs-string">'../completion'</span>, name);
  <span class="hljs-keyword">try</span> {
    console.log(fs.readFileSync(file, <span class="hljs-string">'utf8'</span>));
    process.exit(<span class="hljs-number">0</span>);
  } <span class="hljs-keyword">catch</span> (err) {
    console.log(
      <span class="hljs-string">'echo "gulp autocompletion rules for'</span>,
